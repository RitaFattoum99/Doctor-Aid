...
const coolWhite2=Color.fromRGBO(248, 249, 253, 1);
...
//border: 0.75px solid rgba(115, 115, 115, 1)

//background: rgba(33, 129, 196, 1);
//background: rgba(84, 84, 85, 1);

//border: 2px solid rgba(126, 199, 250, 1)

//background: rgba(242, 201, 56, 1);

//background: rgba(148, 203, 105, 1);
